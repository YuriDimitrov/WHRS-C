sap.ui.define([
    ...
    "use strict";
    return Controller.extend("sap.ui.cons.controller.Recommend", {
        onInit: function () {
            var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
            oRouter.getRoute("recommend").attachPatternMatched(this._onObjectMatched, this);
        },
        _onObjectMatched: function (oEvent) {
            var oModelOData = this.getOwnerComponent().getModel('consModel');            
        ...
        onCategoryPress: function (oEvent) {
            var category = oEvent.getSource().getBindingContext("consModel").getObject();            
            var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
            sap.ui.getCore().AppContext.chosenCategory = category.id;
            oRouter.navTo("countries", {
